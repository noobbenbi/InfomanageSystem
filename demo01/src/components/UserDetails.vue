  ...
  <div class="details container">
    <router-link to="/" class="btn btn-default">返回</router-link>
      ...
      <ul class="list-group">
        ...
        <li class="list-group-item"><span class="glyphicon glyphicon-education"> {{customer.guaduationschool}} </span></li>
      </ul>
      <ul class="list-group">
        <li class="list-group-item"><span class="glyphicon glyphicon-star"> {{customer.profession}} </span></li>
        <li class="list-group-item"><span class="glyphicon glyphicon-tag"> {{customer.decription}} </span></li>
      </ul>
  </div>
</template>
